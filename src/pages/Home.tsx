...
export default function Home() {
  return (
    <div className='min-h-[calc(100vh-4rem)] px-4 sm:px-6 lg:px-8 pt-8 sm:pt-16'>
      {/* Hero Section */}
      <div className='flex items-center justify-center min-h-[calc(100vh-8rem)] sm:min-h-[calc(100vh-4rem)]'>
        <div className='text-center max-w-4xl mx-auto'>
          ...
          <div className='flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center px-4'>
            <button className='w-full sm:w-auto flex items-center justify-center gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors font-semibold text-base sm:text-lg min-w-[160px]'>
              <HiUsers className='w-5 h-5' />
              Create Trade
            </button>
            <Link
              to='/products'
              className='w-full sm:w-auto flex items-center justify-center gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-transparent border-2 border-blue-500 hover:bg-blue-500/10 text-blue-400 rounded-lg transition-colors font-semibold text-base sm:text-lg min-w-[160px] text-center no-underline'
            >
            ...
            <Link
              to='/list-product'
              className='w-full sm:w-auto flex items-center justify-center gap-3 px-6 sm:px-8 py-3 sm:py-4 bg-transparent border-2 border-gray-500 hover:bg-gray-500/10 text-gray-300 rounded-lg transition-colors font-semibold text-base sm:text-lg min-w-[160px] text-center no-underline'
            >
      ...
      <div className='max-w-6xl mx-auto py-12 sm:py-20 px-4'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12'>
          {/* For Buyers */}
          <div className='bg-black/30 border border-blue-500 rounded-xl p-6 sm:p-8 space-y-6 sm:space-y-8'>
